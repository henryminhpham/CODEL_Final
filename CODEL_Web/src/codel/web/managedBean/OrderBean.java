...
public class OrderBean implements Serializable {
	...
	private static final ArrayList<Order> orderList = new ArrayList<Order>(
			...
			new Order("A0001", "Intel CPU", new BigDecimal("700.00"), 1),
					new Order("A0002", "Harddisk 10TB",
							...
							"Dell Laptop", new BigDecimal("11600.00"), 8),
					new Order("A0004", "Samsung LCD",
							new BigDecimal("5200.00"), 3), new Order("A0005",
							"A4Tech Mouse", new BigDecimal("100.00"), 10)));
	...
	public static class Order {
		...
		public Order(String orderNo, String productName, BigDecimal price,
				int qty) {
